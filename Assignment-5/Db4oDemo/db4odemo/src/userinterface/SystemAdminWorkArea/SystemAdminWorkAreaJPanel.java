...
public class SystemAdminWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void btnManageCustomersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageCustomersActionPerformed
        ManageCustomerScreenJPanel manageCustomerScreenJPanel=new ManageCustomerScreenJPanel(userProcessContainer, ecosystem);
    ...
    private void btnManageDeliveryManActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageDeliveryManActionPerformed
        ManageDeliveryManScreenJPanel manageEnterpriseJPanel=new ManageDeliveryManScreenJPanel(userProcessContainer, ecosystem);
        userProcessContainer.add("ManageDeliveryManScreenJPanel ",manageEnterpriseJPanel);
        CardLayout layout=(CardLayout)userProcessContainer.getLayout();
        layout.next(userProcessContainer);
